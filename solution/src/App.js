...
function App() {
  ...
  const Button = ({ number }) => {
    return (
      <button onClick={() => setItems(number)} className="btn-number bg-gray-700 h-10 w-10 rounded-full pt-1 text-gray-200 focus:bg-gray-400 transition-all duration-200">
        {number}
      </button>
    );
  };
    ...
    <>
      {!isSubmitted && (
        <div className="wrapper">
          ...
          <p className="text-gray-100 mb-10"> Please let us know how we did with your support request. All feedback is appreciated to help us improve our offering!</p>
...
const ThankYou = ({ items, setIsSubmitted }) => {
  return (
    <div className="wrapper">
      ...
      <p className="text-gray-100 text-center mb-10">We appreciate you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!</p>
      <div className="text-center">
